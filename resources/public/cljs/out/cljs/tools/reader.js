...
var G__21810 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__21810;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__21811 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__21811,ch);
...
if(("\\" === ch__$1)){
var ch_21812__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_21812__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_21812__$2);
} else {
}

var G__21813 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__21813;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__3921__auto__ = cljs.tools.reader.impl.utils.whitespace_QMARK_.call(null,ch);
if(or__3921__auto__){
return or__3921__auto__;
} else {
var or__3921__auto____$1 = cljs.tools.reader.macros.call(null,ch);
...
var vec__21821 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21821,(0),null);
var start_column = cljs.core.nth.call(null,vec__21821,(1),null);
...
var G__21824 = cljs.core.conj_BANG_.call(null,a,form);
a = G__21824;
continue;
}
}
...
var _STAR_read_delim_STAR_21825 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_21825;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__21826 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21826,(0),null);
var start_column = cljs.core.nth.call(null,vec__21826,(1),null);
...
var vec__21829 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21829,(0),null);
var end_column = cljs.core.nth.call(null,vec__21829,(1),null);
...
var vec__21832 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21832,(0),null);
var start_column = cljs.core.nth.call(null,vec__21832,(1),null);
...
var vec__21835 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21835,(0),null);
var end_column = cljs.core.nth.call(null,vec__21835,(1),null);
...
var vec__21838 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21838,(0),null);
var start_column = cljs.core.nth.call(null,vec__21838,(1),null);
...
var vec__21841 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21841,(0),null);
var end_column = cljs.core.nth.call(null,vec__21841,(1),null);
...
var sb = (function (){var G__21844 = (new goog.string.StringBuffer());
G__21844.append(initch);
...
var or__3921__auto__ = cljs.tools.reader.impl.commons.match_number.call(null,s);
...
var G__21846 = (function (){var G__21845 = sb;
G__21845.append(ch);

return G__21845;
})();
var G__21847 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__21846;
ch = G__21847;
continue;
}
...
switch (G__21850) {
case "\\":
var G__21854 = (function (){var G__21851 = sb;
G__21851.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__21851;
})();
var G__21855 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__21854;
ch = G__21855;
continue;
...
break;
default:
var G__21856 = (function (){var G__21852 = sb;
G__21852.append(ch);

return G__21852;
})();
var G__21857 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__21856;
ch = G__21857;
continue;
...
var vec__21858 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21858,(0),null);
var end_column = cljs.core.nth.call(null,vec__21858,(1),null);
...
var vec__21861 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21861,(0),null);
var column = cljs.core.nth.call(null,vec__21861,(1),null);
...
var or__3921__auto__ = cljs.tools.reader.resolve_alias.call(null,sym);
if(cljs.core.truth_(or__3921__auto__)){
return or__3921__auto__;
} else {
...
var line = cljs.core.nth.call(null,vec__21866,(0),null);
var column = cljs.core.nth.call(null,vec__21866,(1),null);
...
var m__$1 = (cljs.core.truth_((function (){var and__3910__auto__ = line;
...
var vec__21871 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21871,(0),null);
var column = cljs.core.nth.call(null,vec__21871,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__21876 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21876,(0),null);
var start_column = cljs.core.nth.call(null,vec__21876,(1),null);
...
var vec__21879 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21879,(0),null);
var end_column = cljs.core.nth.call(null,vec__21879,(1),null);
...
var G__21882 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__21882,true,null,opts,pending_forms);
...
var G__21883 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__21883)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__21883)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__21883)){
...
if((form === cljs.tools.reader.READ_EOF)){
return cljs.tools.reader.impl.errors.throw_eof_error.call(null,rdr,(function (){var and__3910__auto__ = (first_line < (0));
...
var _STAR_suppress_read_STAR_21884 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_21884;
}});
...
var G__21885 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__21885,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__21885,rdr,first_line);

return G__21885;
} else {
var or__3921__auto__ = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
if(cljs.core.truth_(or__3921__auto__)){
return or__3921__auto__;
} else {
...
var G__21889 = matched;
var G__21890 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__21889;
finished = G__21890;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__3910__auto__ = opts;
if(cljs.core.truth_(and__3910__auto__)){
...
var _STAR_suppress_read_STAR_21891 = cljs.tools.reader._STAR_suppress_read_STAR_;
cljs.tools.reader._STAR_suppress_read_STAR_ = (function (){var or__3921__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__3921__auto__)){
return or__3921__auto__;
} else {
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_21891;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env21892 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__21893 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__21893,"(");
...
var G__21894 = (i + (1));
var G__21895 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3921__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3921__auto__)){
return or__3921__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env21892;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__21896 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__21896);
...
var G__21899 = cljs.core.next.call(null,s);
var G__21900 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__21899;
key_vals = G__21900;
continue;
} else {
...
var or__3921__auto__ = cljs.core.get.call(null,cljs.tools.reader.gensym_env,sym);
if(cljs.core.truth_(or__3921__auto__)){
return or__3921__auto__;
} else {
...
if((function (){var and__3910__auto__ = ((!((form == null)))?(((((form.cljs$lang$protocol_mask$partition0$ & (262144))) || ((cljs.core.PROTOCOL_SENTINEL === form.cljs$core$IWithMeta$))))?true:false):false);
if(and__3910__auto__){
...
return cljs.tools.reader.add_meta.call(null,form,((cljs.core.special_symbol_QMARK_.call(null,form))?(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,form,null,(1),null)),(2),null)):(((form instanceof cljs.core.Symbol))?(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,(cljs.core.truth_((function (){var and__3910__auto__ = cljs.core.not.call(null,cljs.core.namespace.call(null,form));
if(and__3910__auto__){
...
))))):(cljs.core.truth_((function (){var or__3921__auto__ = (form instanceof cljs.core.Keyword);
if(or__3921__auto__){
return or__3921__auto__;
} else {
var or__3921__auto____$1 = typeof form === 'number';
if(or__3921__auto____$1){
return or__3921__auto____$1;
} else {
var or__3921__auto____$2 = typeof form === 'string';
if(or__3921__auto____$2){
return or__3921__auto____$2;
} else {
var or__3921__auto____$3 = (form == null);
if(or__3921__auto____$3){
return or__3921__auto____$3;
} else {
var or__3921__auto____$4 = cljs.tools.reader.bool_QMARK_.call(null,form);
if(cljs.core.truth_(or__3921__auto____$4)){
return or__3921__auto____$4;
} else {
...
var gensym_env21904 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env21904;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__21905 = token;
var G__21905__$1 = (((G__21905 == null))?null:cljs.core.subs.call(null,G__21905,(1)));
var G__21905__$2 = (((G__21905__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__21905__$1));
var G__21905__$3 = (((G__21905__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__21905__$2));
var G__21905__$4 = (((G__21905__$3 == null))?null:cljs.core.symbol.call(null,G__21905__$3));
if((G__21905__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__21905__$4);
}
})():(function (){var G__21906 = token;
var G__21906__$1 = (((G__21906 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__21906));
if((G__21906__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__21906__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
var temp__5455__auto__ = (function (){var or__3921__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__3921__auto__)){
return or__3921__auto__;
} else {
...
}catch (e21913){if((e21913 instanceof Error)){
var e = e21913;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__21917,reader){
var map__21918 = p__21917;
var map__21918__$1 = ((((!((map__21918 == null)))?(((((map__21918.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21918.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21918):map__21918);
var opts = map__21918__$1;
var eof = cljs.core.get.call(null,map__21918__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4498__auto___21926 = arguments.length;
var i__4499__auto___21927 = (0);
while(true){
if((i__4499__auto___21927 < len__4498__auto___21926)){
args__4501__auto__.push((arguments[i__4499__auto___21927]));

var G__21928 = (i__4499__auto___21927 + (1));
i__4499__auto___21927 = G__21928;
continue;
} else {
}
break;
...
return cljs.tools.reader.read_PLUS_string.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4502__auto__);
});
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq21924){
var G__21925 = cljs.core.first.call(null,seq21924);
var seq21924__$1 = cljs.core.next.call(null,seq21924);
var self__4485__auto__ = this;
return self__4485__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21925,seq21924__$1);
});


//# sourceMappingURL=reader.js.map?rel=1521885143049
