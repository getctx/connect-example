...
var or__3921__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj29110 = {"detail":data};
return obj29110;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__3910__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__3910__auto__)){
var and__3910__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__29117 = cljs.core._EQ_;
var expr__29118 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29117.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29118))){
return ((function (pred__29117,expr__29118){
return (function (p1__29111_SHARP_){
return console.warn(p1__29111_SHARP_);
});
;})(pred__29117,expr__29118))
} else {
if(cljs.core.truth_(pred__29117.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29118))){
return ((function (pred__29117,expr__29118){
return (function (p1__29112_SHARP_){
return console.debug(p1__29112_SHARP_);
});
;})(pred__29117,expr__29118))
} else {
if(cljs.core.truth_(pred__29117.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29118))){
return ((function (pred__29117,expr__29118){
return (function (p1__29113_SHARP_){
return console.error(p1__29113_SHARP_);
});
;})(pred__29117,expr__29118))
} else {
return ((function (pred__29117,expr__29118){
return (function (p1__29114_SHARP_){
return console.log(p1__29114_SHARP_);
});
;})(pred__29117,expr__29118))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29121){
...
var eval_fn = cljs.core.get.call(null,map__29122__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29124_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__29126,(0),null);
var v = cljs.core.nth.call(null,vec__29126,(1),null);
...
if(cljs.core.truth_((function (){var and__3910__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1521885154567
