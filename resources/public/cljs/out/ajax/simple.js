...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__31946){
...
var handler = cljs.core.get.call(null,map__31947__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__3921__auto__ = p1__31949_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__31950){
...
var request = map__31951__$1;
var interceptors = cljs.core.get.call(null,map__31951__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__3921__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__3921__auto__)){
return or__3921__auto__;
} else {
...
//# sourceMappingURL=simple.js.map?rel=1521885209875
